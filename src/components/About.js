  ...
  return (
    <div className='about d-flex flex-column align-items-center 
      ...
      <div className='d-flex flex-row align-items-center justify-content-between w-100'>
        ...
        <div className='ms-4'>
          <p>My name is Khoi. I am a Fulbright student and I program for fun. I don't like copying class schedule to paper when thinking which courses to choose before a semester. Therefore, I built OneSchedule. This app is inspried by <a href='https://nusmods.com/' target="_blank" rel="noreferrer">NUSMods</a>.</p>
