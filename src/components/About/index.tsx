    ...
    <div className='d-flex flex-column text-start m-auto col-lg-8'>
      ...
      <h2 className='my-4'>About this website</h2>
        <div className='d-flex flex-column flex-md-row align-items-center justify-content-between'>
          <div className=''>
            <p>This website is founded by Khoi, a Fulbright CS student. He didn&apos;t like copying class schedule to paper when selecting courses each semester. Therefore, he built <b>OneSchedule</b> to help visualize <b>schedules</b> in <b>one</b> minute.</p>
            <p>
